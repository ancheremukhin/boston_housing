...
def explore_city_data(city_data):
    ...
    print("Size of data (number of houses) = {0}".format(housing_prices.size))
    # Number of features?
    print("Number of features = {0}".format(housing_features.shape[1]))
    # Minimum price?
    print("Minimum price = {0}".format(np.amin(housing_prices)))
    # Maximum price?
    print("Maximum price = {0}".format(np.amax(housing_prices)))
    # Calculate mean price?
    print("Mean price = {0}".format(np.mean(housing_prices)))
    # Calculate median price?
    print("Median price = {0}".format(np.median(housing_prices)))
    # Calculate standard deviation?
    print("Standard deviation price = {0}".format(np.std(housing_prices)))
